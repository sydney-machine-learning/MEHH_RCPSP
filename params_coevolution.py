...
NUM_GENERATIONS=64 # Number of generation to evolve  NOTE : EACH GENERATION ONLY ONE SPECIES EVOLVES SO NUM_GENERATIONS SHOULD BE ACTUAL GENERATIONS x NUM_SPECIES
